...
\IEEEauthorblockA{Samsung Instituto de Desenvolvimento \\para a Informática da Amazônia (SIDIA)\\
Manaus, Brasil\\
...
\input{./tex/TrabalhosRelacionados.tex}
\input{./tex/ReferenciasTeoricos.tex}
\input{./tex/Aplicacao.tex}
\input{./tex/Editor.tex}
\input{./tex/Exemplos.tex}
